...
"       License:    GPL
"
" TODO: move filetype specifics to separate files in a subdir; implement filereading based on filetype
"
" Changelog
" ---------
"
...
"  * Added {{{ headers for each syntax section
"
" 0.6.0
...
function! s:SimpleFold_FoldText()
    ...
    if numspaces > 0
        ...
        let spaces = strpart(spacefill, 1, numspaces - len(folddepth))
    else
        let spaces = ' '
    endif
